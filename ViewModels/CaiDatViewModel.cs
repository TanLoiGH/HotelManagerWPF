...
public class CaiDatViewModel : BaseViewModel
{
    ...
    public CaiDatViewModel(EmployeeService employeeSvc, IAuthService authSvc, IHoaDonService hoaDonSvc)
    {
        ...
        _isDarkMode = QuanLyKhachSan_PhamTanLoi.Properties.Settings.Default.IsDarkMode;
    ...
    public string HoTen
    {
        ...
        set
        {
            if (SetProperty(ref _hoTen, value)) UpdateInfoCommand.RaiseCanExecuteChanged();
        }
    }
    ...
    public string SoDienThoai
    {
        ...
        set
        {
            if (SetProperty(ref _soDienThoai, value)) UpdateInfoCommand.RaiseCanExecuteChanged();
        }
    }
    ...
    public string MatKhauCu
    {
        ...
        set
        {
            if (SetProperty(ref _matKhauCu, value)) ChangePasswordCommand.RaiseCanExecuteChanged();
        }
    }
    ...
    public string MatKhauMoi
    {
        ...
        set
        {
            if (SetProperty(ref _matKhauMoi, value)) ChangePasswordCommand.RaiseCanExecuteChanged();
        }
    }
    ...
    public string XacNhanMatKhau
    {
        ...
        set
        {
            if (SetProperty(ref _xacNhanMatKhau, value)) ChangePasswordCommand.RaiseCanExecuteChanged();
        }
    }

    public bool CanUpdate => !string.IsNullOrWhiteSpace(HoTen) && !string.IsNullOrWhiteSpace(SoDienThoai);

    public bool CanChangePassword => !string.IsNullOrWhiteSpace(MatKhauCu) && !string.IsNullOrWhiteSpace(MatKhauMoi) &&
                                     (MatKhauMoi == XacNhanMatKhau) && MatKhauMoi.Length >= 6;
    ...
    private void LoadSystemSettings()
    {
        ...
        {
            Logger.LogError("Lỗi load settings", ex);
        }
    }
    ...
    private async Task LoadCurrentUserInfoAsync()
    {
        ...
        {
            Logger.LogError("Lỗi load info", ex);
        }
    }
